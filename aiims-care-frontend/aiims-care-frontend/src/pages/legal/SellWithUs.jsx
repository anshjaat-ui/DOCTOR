  ...
  return (
    <main className="bg-medi-bg min-h-[70vh] font-sans">
      <div className="max-w-3xl mx-auto px-4 py-10 bg-medi-panel border border-accent/20 my-6 rounded-lg">
        <h1 className="text-2xl font-bold mb-4 text-white">Sell on AIIMS Care</h1>

        <div className="space-y-4 text-sm text-gray-300">
          <p>
            Are you a manufacturer, wholesaler, or brand looking to reach more customers? Partner
            with AIIMS Care and grow your business online.
          </p>
          ...
          {/* ✅ FIX START */}
          <a
            href="mailto:sellers@aiimscare.com"
            className="inline-flex items-center gap-2 text-accent hover:underline"
          >
            <Mail size={16} />
            sellers@aiimscare.com
          </a>
          {/* ✅ FIX END */}
