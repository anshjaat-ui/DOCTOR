    ...
    <main className="bg-medi-bg min-h-[70vh] font-sans">
      <div className="max-w-3xl mx-auto px-4 py-10 bg-medi-panel border border-accent/20 my-6 rounded-lg">
        ...
        <div className="space-y-4 text-sm text-gray-300">
          <p>By accessing and using AIIMS Care, you agree to be bound by these Terms and Conditions.</p>

          <h2 className="font-bold text-base mt-6 text-accent">Use of the Website</h2>
          ...
          <h2 className="font-bold text-base mt-6 text-accent">Product Listings</h2>
          ...
          <h2 className="font-bold text-base mt-6 text-accent">Pricing and Payment</h2>
          <p>All prices are listed in Indian Rupees (INR) and are inclusive of applicable taxes unless stated otherwise. Payment is currently accepted via Cash on Delivery (COD). Orders are confirmed after our team verifies delivery details.</p>

          <h2 className="font-bold text-base mt-6 text-accent">Order Cancellation</h2>
          ...
          <h2 className="font-bold text-base mt-6 text-accent">Limitation of Liability</h2>
          <p>AIIMS Care shall not be liable for any indirect, incidental, or consequential damages arising from the use of this website or products purchased through it.</p>

          <h2 className="font-bold text-base mt-6 text-accent">Governing Law</h2>
          ...
          <h2 className="font-bold text-base mt-6 text-accent">Changes to Terms</h2>
