    ...
    <main className="bg-medi-bg min-h-[70vh] font-sans">
      <div className="max-w-3xl mx-auto px-4 py-10 bg-medi-panel border border-accent/20 my-6 rounded-lg">
        ...
        <div className="space-y-4 text-sm text-gray-300">
          <h2 className="font-bold text-base mt-6 text-accent">Returns</h2>
          ...
          <h2 className="font-bold text-base mt-6 text-accent">Non-Returnable Items</h2>
          ...
          <h2 className="font-bold text-base mt-6 text-accent">How to Request a Return</h2>
          ...
          <h2 className="font-bold text-base mt-6 text-accent">Refunds</h2>
          <p>Once we receive and inspect the returned item, we will process your refund within 5-7 business days. Since orders are Cash on Delivery, refunds are processed via bank transfer or UPI to the details you provide.</p>

          <h2 className="font-bold text-base mt-6 text-accent">Damaged or Defective Items</h2>
          ...
          <h2 className="font-bold text-base mt-6 text-accent">Order Cancellations</h2>
