    ...
    <main className="bg-medi-bg min-h-[70vh] font-sans">
      <div className="max-w-3xl mx-auto px-4 py-10 bg-medi-panel border border-accent/20 my-6 rounded-lg">
        ...
        <div className="space-y-4 text-sm text-gray-300">
          <h2 className="font-bold text-base mt-6 text-accent">Delivery Areas</h2>
          ...
          <h2 className="font-bold text-base mt-6 text-accent">Shipping Charges</h2>
          <p>Orders above ₹499 qualify for free shipping. Orders below this amount incur a flat shipping fee of ₹49.</p>

          <h2 className="font-bold text-base mt-6 text-accent">Delivery Timelines</h2>
          ...
          <h2 className="font-bold text-base mt-6 text-accent">Order Tracking</h2>
          ...
          <h2 className="font-bold text-base mt-6 text-accent">Delays</h2>
